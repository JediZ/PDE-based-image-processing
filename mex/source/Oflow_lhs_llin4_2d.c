/*
function [AU AV] = oflow_lhs_llin4_2d(U_in, V_in, dU_in, dV_in, M, Cu_in, Cv_in, Du, Dv, wW, wN, wE, wS, iter)

Calculates LHS (left hand size of Ax = b) of the optical flow equations using nonlinear diffusion as smoothness term and 
late linearization of the constancy terms.
                 ...
                 const mxArray *prhs[])
{
	...
	*/
	...
	if (nrhs != 11) {
		mexErrMsgTxt("oplhs_llin4_2d parameter error: wrong number of input parameters!");
	} 
	/*
	//------------
	//--- U in ---
	...
	*/
	...
	if (!mxIsSingle(prhs[0])){
		mexErrMsgTxt("oplhs_llin4_2d error: 'U_in' must be a noncomplex single-valued matrix.");
	}
	...
	*/
	...
	if (!mxIsSingle(prhs[1])){
		mexErrMsgTxt("oplhs_llin4_2d error: 'V_in' must be a noncomplex single-valued matrix.");
	}
	/*Get number of dimensions and elements per dimension */
	...
	*/
	...
	if (!mxIsSingle(prhs[2])){
		mexErrMsgTxt("oplhs_llin4_2d error: 'dU_in' must be a noncomplex single-valued matrix.");
	}
	/*Get number of dimensions and elements per dimension */
	...
	*/
	...
	if (!mxIsSingle(prhs[3])){
		mexErrMsgTxt("oplhs_llin4_2d error: 'dV_in' must be a noncomplex single-valued matrix.");
	}
	/*Get number of dimensions and elements per dimension */
	...
	*/
	...
	if (!mxIsSingle(prhs[4])){
		mexErrMsgTxt("oplhs_llin4_2d error: 'M' must be a noncomplex single-valued matrix.");
	}
	/*Get number of dimensions and elements per dimension */
	...
	*/
	...
	if (!mxIsSingle(prhs[5])){
		mexErrMsgTxt("oplhs_llin4_2d error: 'Du' must be a noncomplex single-valued matrix.");
	}
	/*Get number of dimensions and elements per dimension */
	...
	*/
	...
	if (!mxIsSingle(prhs[6])){
		mexErrMsgTxt("oplhs_llin4_2d error: 'Dv' must be a noncomplex single-valued matrix.");
	}
	/*Get number of dimensions and elements per dimension */
	...
	*/
	...
	if (!mxIsSingle(prhs[7])){
		mexErrMsgTxt("oplhs_llin4_2d error: 'wW' must be a noncomplex single-valued matrix.");
	}
	/*Get number of dimensions and elements per dimension */
	...
	*/
	...
	if (!mxIsSingle(prhs[8])){
		mexErrMsgTxt("oplhs_llin4_2d error: 'wN' must be a noncomplex single-valued matrix.");
	}
	/*Get number of dimensions and elements per dimension */
	...
	*/
	...
	if (!mxIsSingle(prhs[9])){
		mexErrMsgTxt("oplhs_llin4_2d error: 'wE' must be a noncomplex single-valued matrix.");
	}
	/*Get number of dimensions and elements per dimension */
	...
	*/
	...
	if (!mxIsSingle(prhs[10])){
		mexErrMsgTxt("oplhs_llin4_2d error: 'wS' must be a noncomplex single-valued matrix.");
	}
	/*Get number of dimensions and elements per dimension */
	...
	*/
	...
	if( nlhs<2 ){
		mexErrMsgTxt("oplhs_llin4_2d insufficient number of outputs. Outputs from this function are 'AU' and 'AV'");
	}else{
	
		if( (plhs[0] = mxCreateNumericArray(AU.ndims, AU.dimElems, mxSINGLE_CLASS, mxREAL))==NULL )
			mexErrMsgTxt("oplhs_llin4_2d: error reserving space for output variable 'AU'");
		if( (AU.data = (float*)mxGetPr( plhs[0] ))==NULL )
			mexErrMsgTxt("oplhs_llin4_2d: error obtaining pointer to output variable 'AU'");
	
		if( (plhs[1] = mxCreateNumericArray(AV.ndims, AV.dimElems, mxSINGLE_CLASS, mxREAL))==NULL )
			mexErrMsgTxt("oplhs_llin4_2d: error reserving space for output variable 'AV'");
		if( (AV.data = (float*)mxGetPr( plhs[1] ))==NULL )
			mexErrMsgTxt("oplhs_llin4_2d: error obtaining pointer to output variable 'AV'");
	}

	LHS_llin4_2d(&AU, &AV, &U_in, &V_in, &dU_in, &dV_in, &M, &Du, &Dv, &wW, &wN, &wE, &wS, Mparam);
}
